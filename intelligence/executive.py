...
def _generate_executive_summary(
    ...
    lines = [
        "## 📊 WEEKLY DELIVERY EXECUTIVE DASHBOARD",
        "",
        "### 🛡️ HEALTH METRICS",
        f"*   **Delivery Risk Score**: `{d_score}/100` — **{d_label}**",
        f"*   **Team Health Score**: `{h_score}/100` — **Grade: {h_grade}**",
        "",
        "### 🚀 VELOCITY & FORECAST",
        f"*   **Historical Velocity**: {avg_vel:.0f} SP/sprint ({trend} trend)",
        f"*   **Risk-Adjusted Velocity**: {adj_vel:.1f} SP/sprint",
        f"*   **Remaining Backlog**: {remaining_sp:.0f} SP",
        f"*   **Completion Forecast**: **{p50} sprints** (Realistic) / **{p85} sprints** (Safe)",
        "",
        "### 📅 SPRINT DELIVERY PERFORMANCE",
        f"*   **Avg. SP Completion Rate**: {avg_sp_rate}%",
        f"*   **Recent Verdict**: {retro_verdict}",
        f"*   **Unresolved Carry-over**: {stale_count} items ({stale_sp:.0f} SP)",
        "",
        "### 🔍 TOP RISK FACTORS",
    ]
